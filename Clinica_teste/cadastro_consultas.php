                    ...
                    <form class="formulario" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" name="txt_nome" placeholder="Ex: Consulta de rotina">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="time" class="form-control" id="inputAddress" name="txt_cpf" placeholder="EX: 111111111-11">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="inputAddress">Paciente</label>
                                <select name="txt_paciente" class="form-control" id="exampleFormControlSelect1">
                                    <?php
                                    require_once './classes/DAO/conexao.php';
                                    $conexao = new conexao();
                                    $pdo = $conexao->Conectar();
                                    $consulta = $pdo->query("SELECT pac_nome, pac_cpf FROM pacientes ORDER BY pac_nome");
                                    echo ("<option>Selecione o Paciente</option>");
                                    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {

                                        echo ("<option>" . "CPF: " . $linha['pac_cpf'] . "&nbsp;&nbsp;&nbsp;" . $linha['pac_nome'] . "</option>");
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="txt_medico" class="form-control" id="exampleFormControlSelect1">
                                    <?php
                                    require_once './classes/DAO/conexao.php';
                                    $conexao1 = new conexao();
                                    $pdo2 = $conexao->Conectar();
                                    $consulta2 = $pdo->query("SELECT med_crm, med_nome, med_especialidade FROM medicos ORDER BY med_nome");
                                    echo ("<option>Selecione o Médico</option>");
                                    while ($linha2 = $consulta2->fetch(PDO::FETCH_ASSOC)) {
                                        echo ("<option>" . "CRM: " . $linha2['med_crm'] . "&nbsp;&nbsp;&nbsp;" . $linha2['med_nome'] . "&nbsp;&nbsp;&nbsp;Especialidade: " . $linha2['med_especialidade'] . "</option>");
                                    }
                                    ?>
                                </select>
                            </div>
